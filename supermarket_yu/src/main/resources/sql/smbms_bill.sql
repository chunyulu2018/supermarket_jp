...
CREATE TABLE `smbms_bill`  (
  ...
  `billCode` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '账单コード',
  ...
  `providerId` bigint(20) NULL DEFAULT NULL COMMENT 'サプライヤID',
