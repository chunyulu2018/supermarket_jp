...
$(function(){
	...
	$.ajax({
		...
		error:function(data){//当访问时候，404，500 等非200的错误状态码
			validateTip(providerId.next(),{"color":"red"},imgNo+" スプライヤ リストの取得エラー",false);
		}
	});
	/*
	 * 验证
	...
	productName.on("focus",function(){
		...
		if(productName.val() != null && productName.val() != ""){
			...
			validateTip(productName.next(),{"color":"red"},imgNo+" 商品名を空白にすることはできません。再入力してください",false);
		}
	...
	productUnit.on("focus",function(){
		...
		if(productUnit.val() != null && productUnit.val() != ""){
			...
			validateTip(productUnit.next(),{"color":"red"},imgNo+" 商品単位を空白にすることはできません。再入力してください",false);
		}
	...
	providerId.on("focus",function(){
		...
		if(providerId.val() != null && providerId.val() != "" && providerId.val() != 0){
			...
			validateTip(providerId.next(),{"color":"red"},imgNo+" サプライヤは空白にすることは出来ません、選択してください。",false);
		}
